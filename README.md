...
> Бесплатное TG mini-app + PWA для общения и поддержки детей с аутизмом и их семей. 6 модулей, работает офлайн, без рекламы, без подписки, без сбора персональных данных. Русскоязычное, под российский быт.
...
Pull requests welcome. Если у вас есть feedback — open issue. Если вы родитель ребёнка с аутизмом и хотите попасть в бету — напишите в [@skol4356](https://t.me/skol4356).
